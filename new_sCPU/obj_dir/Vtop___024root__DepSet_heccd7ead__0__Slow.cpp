...
VL_ATTR_COLD void Vtop___024root___eval_initial__TOP(Vtop___024root* vlSelf) {
    ...
    VL_READMEM_N(true, 8, 16, 0, VL_CVT_PACK_STR_NW(3, __Vtemp_h375dd916__0)
                 ,  &(vlSelf->top__DOT__rom__DOT__mem)
                 , 0, ~0ULL);
}
...
VL_ATTR_COLD void Vtop___024root___stl_sequent__TOP__0(Vtop___024root* vlSelf) {
    ...
    vlSelf->debug3 = vlSelf->top__DOT__gpr__DOT__regs
        [3U];
    vlSelf->rom_debug0 = vlSelf->top__DOT__rom__DOT__mem
        [0U];
    vlSelf->rom_debug1 = vlSelf->top__DOT__rom__DOT__mem
        [1U];
    vlSelf->rom_debug2 = vlSelf->top__DOT__rom__DOT__mem
        [2U];
    vlSelf->rom_debug3 = vlSelf->top__DOT__rom__DOT__mem
        [3U];
...
VL_ATTR_COLD void Vtop___024root___ctor_var_reset(Vtop___024root* vlSelf) {
    ...
    vlSelf->top__DOT__rdata1 = VL_RAND_RESET_I(8);
    vlSelf->top__DOT__rdata2 = VL_RAND_RESET_I(8);
    vlSelf->top__DOT__pc_next = VL_RAND_RESET_I(4);
    vlSelf->top__DOT__display_num = VL_RAND_RESET_I(8);
    for (int __Vi0 = 0; __Vi0 < 16; ++__Vi0) {
        vlSelf->top__DOT__rom__DOT__mem[__Vi0] = VL_RAND_RESET_I(8);
    }
    for (int __Vi0 = 0; __Vi0 < 4; ++__Vi0) {
        vlSelf->top__DOT__gpr__DOT__regs[__Vi0] = VL_RAND_RESET_I(8);
    }
