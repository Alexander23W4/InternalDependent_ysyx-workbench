...
#endif
                VL_FATAL_MT("/home/wang/InternalDependent_ysyx-workbench/VerTest/nvbtest1/vsrc/vga_top.v", 1, "", "Settle region did not converge.");
            }
...
VL_ATTR_COLD void Vvga_top___024root___dump_triggers__ico(Vvga_top___024root* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    Vvga_top__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vvga_top___024root___dump_triggers__ico\n"); );
    // Body
...
VL_ATTR_COLD void Vvga_top___024root___ctor_var_reset(Vvga_top___024root* vlSelf) {
    ...
    vlSelf->vga_g = 0;
    vlSelf->vga_b = 0;
    vlSelf->vga_top__DOT__vgactrl__DOT__x_cnt = 0;
    vlSelf->vga_top__DOT__vgactrl__DOT__y_cnt = 0;
    vlSelf->__Vdly__vga_top__DOT__vgactrl__DOT__x_cnt = 0;
