...
VL_INLINE_OPT void Vtest2___024root___ico_sequent__TOP__0(Vtest2___024root* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    Vtest2__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vtest2___024root___ico_sequent__TOP__0\n"); );
    // Body
    vlSelf->c = ((IData)(vlSelf->a) ^ (IData)(vlSelf->b));
}

void Vtest2___024root___eval_ico(Vtest2___024root* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    Vtest2__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vtest2___024root___eval_ico\n"); );
    // Body
...
void Vtest2___024root___eval_triggers__ico(Vtest2___024root* vlSelf);
#ifdef VL_DEBUG
...
void Vtest2___024root___eval(Vtest2___024root* vlSelf) {
    ...
    while (__VicoContinue) {
        __VicoContinue = 0U;
        Vtest2___024root___eval_triggers__ico(vlSelf);
        if (vlSelf->__VicoTriggered.any()) {
            __VicoContinue = 1U;
            if (VL_UNLIKELY((0x64U < vlSelf->__VicoIterCount))) {
#ifdef VL_DEBUG
                Vtest2___024root___dump_triggers__ico(vlSelf);
#endif
                VL_FATAL_MT("src/vercode/test2.v", 1, "", "Input combinational region did not converge.");
            }
            vlSelf->__VicoIterCount = ((IData)(1U) 
                                       + vlSelf->__VicoIterCount);
            Vtest2___024root___eval_ico(vlSelf);
        }
    }
    __VnbaIterCount = 0U;
    __VnbaContinue = 1U;
...
#endif
                    VL_FATAL_MT("src/vercode/test2.v", 1, "", "Active region did not converge.");
                }
...
#endif
                VL_FATAL_MT("src/vercode/test2.v", 1, "", "NBA region did not converge.");
            }
