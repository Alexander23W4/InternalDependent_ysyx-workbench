...
VL_ATTR_COLD void Vtest2___024root__trace_full_top_0(void* voidSelf, VerilatedVcd::Buffer* bufp);
void Vtest2___024root__trace_chg_top_0(void* voidSelf, VerilatedVcd::Buffer* bufp);
...
VL_ATTR_COLD void Vtest2___024root__trace_register(Vtest2___024root* vlSelf, VerilatedVcd* tracep) {
    ...
    // Body
    tracep->addFullCb(&Vtest2___024root__trace_full_top_0, vlSelf);
    tracep->addChgCb(&Vtest2___024root__trace_chg_top_0, vlSelf);
    tracep->addCleanupCb(&Vtest2___024root__trace_cleanup, vlSelf);
}

VL_ATTR_COLD void Vtest2___024root__trace_full_sub_0(Vtest2___024root* vlSelf, VerilatedVcd::Buffer* bufp);

VL_ATTR_COLD void Vtest2___024root__trace_full_top_0(void* voidSelf, VerilatedVcd::Buffer* bufp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vtest2___024root__trace_full_top_0\n"); );
    // Init
    Vtest2___024root* const __restrict vlSelf VL_ATTR_UNUSED = static_cast<Vtest2___024root*>(voidSelf);
    Vtest2__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    // Body
    Vtest2___024root__trace_full_sub_0((&vlSymsp->TOP), bufp);
}

VL_ATTR_COLD void Vtest2___024root__trace_full_sub_0(Vtest2___024root* vlSelf, VerilatedVcd::Buffer* bufp) {
    if (false && vlSelf) {}  // Prevent unused
    Vtest2__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vtest2___024root__trace_full_sub_0\n"); );
    // Init
