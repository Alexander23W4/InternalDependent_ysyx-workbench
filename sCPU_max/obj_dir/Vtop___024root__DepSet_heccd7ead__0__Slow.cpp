...
#endif
                VL_FATAL_MT("top.v", 31, "", "Settle region did not converge.");
            }
...
VL_ATTR_COLD void Vtop___024root___ctor_var_reset(Vtop___024root* vlSelf) {
    ...
    vlSelf->top__DOT__next = VL_RAND_RESET_I(3);
    vlSelf->top__DOT__mem_out = VL_RAND_RESET_I(8);
    vlSelf->top__DOT__we = VL_RAND_RESET_I(1);
    vlSelf->top__DOT__write_addr = VL_RAND_RESET_I(2);
    vlSelf->top__DOT__read_addr = VL_RAND_RESET_I(2);
    vlSelf->top__DOT__data_out = VL_RAND_RESET_I(8);
    vlSelf->top__DOT__data_in = VL_RAND_RESET_I(8);
    vlSelf->top__DOT__instr = VL_RAND_RESET_I(8);
    vlSelf->top__DOT__pc = VL_RAND_RESET_I(4);
    vlSelf->top__DOT__pc_next = VL_RAND_RESET_I(4);
    vlSelf->top__DOT__opcode = VL_RAND_RESET_I(2);
    vlSelf->top__DOT__rd = VL_RAND_RESET_I(2);
    vlSelf->top__DOT__rs1 = VL_RAND_RESET_I(2);
    vlSelf->top__DOT__rs2 = VL_RAND_RESET_I(2);
    vlSelf->top__DOT__imm = VL_RAND_RESET_I(4);
    vlSelf->top__DOT__addr = VL_RAND_RESET_I(4);
    vlSelf->top__DOT__num1 = VL_RAND_RESET_I(8);
    vlSelf->top__DOT__num2 = VL_RAND_RESET_I(8);
    vlSelf->top__DOT__result = VL_RAND_RESET_I(8);
    vlSelf->top__DOT__display_num = VL_RAND_RESET_I(8);
