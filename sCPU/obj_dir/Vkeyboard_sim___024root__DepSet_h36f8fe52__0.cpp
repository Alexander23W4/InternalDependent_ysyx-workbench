...
void Vkeyboard_sim___024root___eval_triggers__act(Vkeyboard_sim___024root* vlSelf) {
    ...
    // Body
    vlSelf->__VactTriggered.at(0U) = ((IData)(vlSelf->keyboard_sim__DOT__clk) 
                                      & (~ (IData)(vlSelf->__Vtrigrprev__TOP__keyboard_sim__DOT__clk)));
    vlSelf->__VactTriggered.at(1U) = (((IData)(vlSelf->keyboard_sim__DOT____Vcellinp__receiver_inst__rst) 
                                       & (~ (IData)(vlSelf->__Vtrigrprev__TOP__keyboard_sim__DOT____Vcellinp__receiver_inst__rst))) 
                                      | ((IData)(vlSelf->keyboard_sim__DOT__clk) 
                                         & (~ (IData)(vlSelf->__Vtrigrprev__TOP__keyboard_sim__DOT__clk))));
