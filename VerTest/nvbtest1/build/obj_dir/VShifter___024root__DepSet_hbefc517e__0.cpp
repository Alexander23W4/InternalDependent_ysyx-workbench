...
VL_INLINE_OPT void VShifter___024root___nba_sequent__TOP__0(VShifter___024root* vlSelf) {
    ...
    // Init
    CData/*31:0*/ __Vtemp_hb2eb2773__0;
    // Body
    __Vtemp_hb2eb2773__0 = ((IData)(vlSelf->rst) ? 0U
                             : ((4U & (IData)(vlSelf->mode))
                                 ...
                                 : ((2U & (IData)(vlSelf->mode))
                                     ...
                                     : ((1U & (IData)(vlSelf->mode))
                                         ? (IData)(vlSelf->value)
                                         : 0U))));
    vlSelf->out = __Vtemp_hb2eb2773__0;
}
...
#endif
                    VL_FATAL_MT("/home/wang/InternalDependent_ysyx-workbench/VerTest/nvbtest1/vsrc/Shifter.v", 1, "", "Active region did not converge.");
                }
...
#endif
                VL_FATAL_MT("/home/wang/InternalDependent_ysyx-workbench/VerTest/nvbtest1/vsrc/Shifter.v", 1, "", "NBA region did not converge.");
            }
