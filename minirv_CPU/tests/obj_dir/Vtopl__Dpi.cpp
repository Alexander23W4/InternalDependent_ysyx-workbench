...
//    1. Call Vtopl::{export_function} instead,
...
void get_decode_signals(int* instr_val, int* addi_s, int* add_s, int* jalr_s, int* lui_s, int* lw_s, int* lbu_s, int* sw_s, int* sb_s, int* ebreak_s, int* rd_val, int* rs1_val, int* rs2_val, int* immI_val, int* immU_val, int* immS_val, int* wdata_val, int* rdata1_val, int* rdata2_val, int* wen_val) {
    // DPI export at test_v/topl.v:61:10
    return Vtopl::get_decode_signals(instr_val, addi_s, add_s, jalr_s, lui_s, lw_s, lbu_s, sw_s, sb_s, ebreak_s, rd_val, rs1_val, rs2_val, immI_val, immU_val, immS_val, wdata_val, rdata1_val, rdata2_val, wen_val);
}
#endif
...
void halt(int* endprog) {
    // DPI export at test_v/topl.v:11:10
    return Vtopl::halt(endprog);
}
#endif
