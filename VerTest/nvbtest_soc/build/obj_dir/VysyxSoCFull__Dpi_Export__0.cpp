...
void VysyxSoCFull::halt(int* endprog) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    VysyxSoCFull___024root::halt\n"); );
    // Init
    ...
    VysyxSoCFull__Vcb_halt_t __Vcb = (VysyxSoCFull__Vcb_halt_t)(VerilatedScope::exportFind(__Vscopep, __Vfuncnum));
    (*__Vcb)((VysyxSoCFull__Syms*)(__Vscopep->symsp()), endprog__Vcvt);
    for (size_t endprog__Vidx = 0; endprog__Vidx < 1; ++endprog__Vidx) *endprog = endprog__Vcvt;
}

void VysyxSoCFull::debug_read_all(int* dbg_regs, int* pc, int* mstatus, int* mepc, int* mcause, int* mtvec, long long* mcycle, int* instr) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    VysyxSoCFull___024root::debug_read_all\n"); );
    // Init
    ...
    const VerilatedScope* __Vscopep = Verilated::dpiScope();
    VysyxSoCFull__Vcb_debug_read_all_t __Vcb = (VysyxSoCFull__Vcb_debug_read_all_t)(VerilatedScope::exportFind(__Vscopep, __Vfuncnum));
    (*__Vcb)((VysyxSoCFull__Syms*)(__Vscopep->symsp()), dbg_regs__Vcvt, pc__Vcvt, mstatus__Vcvt, mepc__Vcvt, mcause__Vcvt, mtvec__Vcvt, mcycle__Vcvt, instr__Vcvt);
...
void VysyxSoCFull::check_error(int* ifu_error, int* lsu_error, int* master_validation_error) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    VysyxSoCFull___024root::check_error\n"); );
    // Init
    ...
    const VerilatedScope* __Vscopep = Verilated::dpiScope();
    VysyxSoCFull__Vcb_check_error_t __Vcb = (VysyxSoCFull__Vcb_check_error_t)(VerilatedScope::exportFind(__Vscopep, __Vfuncnum));
    (*__Vcb)((VysyxSoCFull__Syms*)(__Vscopep->symsp()), ifu_error__Vcvt, lsu_error__Vcvt, master_validation_error__Vcvt);
...
void VysyxSoCFull::check_end(int* period_end) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    VysyxSoCFull___024root::check_end\n"); );
    // Init
    ...
    const VerilatedScope* __Vscopep = Verilated::dpiScope();
    VysyxSoCFull__Vcb_check_end_t __Vcb = (VysyxSoCFull__Vcb_check_end_t)(VerilatedScope::exportFind(__Vscopep, __Vfuncnum));
    (*__Vcb)((VysyxSoCFull__Syms*)(__Vscopep->symsp()), period_end__Vcvt);
