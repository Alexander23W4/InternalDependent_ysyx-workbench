...
VL_ATTR_COLD void Vclint_tb_ysyx_26040135_AXI4___ctor_var_reset(Vclint_tb_ysyx_26040135_AXI4* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    Vclint_tb__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+          Vclint_tb_ysyx_26040135_AXI4___ctor_var_reset\n"); );
    // Body
