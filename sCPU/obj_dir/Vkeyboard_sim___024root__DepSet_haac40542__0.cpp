...
VL_INLINE_OPT VlCoroutine Vkeyboard_sim___024root___eval_initial__TOP__1(Vkeyboard_sim___024root* vlSelf) {
    ...
    co_await vlSelf->__VdlySched.delay(0x4e20ULL, "RTL/Tests/keyboard_sim.v", 
                                       52);
    ...
    co_await vlSelf->__VdlySched.delay(0x7530ULL, "RTL/Tests/ps2_keyboard_model.v", 
                                       24);
    vlSelf->keyboard_sim__DOT__kbd_clk = 1U;
    co_await vlSelf->__VdlySched.delay(0xc350ULL, "RTL/Tests/keyboard_sim.v", 
                                       91);
    ...
    co_await vlSelf->__VdlySched.delay(0xf4240ULL, 
                                       "RTL/Tests/keyboard_sim.v", 
                                       108);
    VL_STOP_MT("RTL/Tests/keyboard_sim.v", 109, "");
}
...
#endif
                    VL_FATAL_MT("RTL/Tests/keyboard_sim.v", 4, "", "Active region did not converge.");
                }
...
#endif
                VL_FATAL_MT("RTL/Tests/keyboard_sim.v", 4, "", "NBA region did not converge.");
            }
